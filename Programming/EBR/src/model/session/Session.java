...
public class Session {
	...
	public Session(String id, Bike bike, CreditCard card, LocalDateTime startTime, LocalDateTime endTime,
			PaymentTransaction rentTransaction, PaymentTransaction returnTransaction) {
		this.id = id;
		this.bike = bike;
		this.card = card;
		this.startTime = startTime;
	...
	public boolean equals(Object o) {
		...
		return bike.equals(session.bike) && card.equals(session.card) && startTime.equals(session.startTime);
	}
}
