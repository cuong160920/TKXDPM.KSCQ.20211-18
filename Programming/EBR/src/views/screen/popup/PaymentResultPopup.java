...
public class PaymentResultPopup extends Popup implements Initializable {
	...
	private PaymentResultPopup(Stage stage, BaseScreenHandlerWithTransactionPopup screenHandler,
			PaymentTransaction paymentTransaction, String paymentMessage) throws IOException {
	 ...
	 */
	private static PaymentResultPopup popup(PaymentTransaction paymentTransaction,
			BaseScreenHandlerWithTransactionPopup screenHandler, String paymentMessage) throws IOException {
	 ...
	 * @throws IOException IO errors
	 */
	public static void display(BaseScreenHandlerWithTransactionPopup screenHandler,
			PaymentTransaction paymentTransaction, String paymentMessage) throws IOException {
